...
# Lesson 16: Partial Autocorrelation 
...
If $\{ X_t \}$ has mean zero, the PACF at lag $h$ is given by solving the Yule-Walker equations of order $h$, and taking the last coefficient, i.e., letting $\underline{e}_h$
 denote the length $h$ unit vector with one in the last position, 
\[
...
- Compute the PACF of Example 5.5.7.
