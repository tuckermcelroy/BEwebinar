...
- Away from $\lambda = 0$, the phase delay is $\Upsilon (\lambda) = 1/2 (1 - \pi/\lambda)$.
This is negative for $\lambda \in (0,\pi]$, so differencing causes and advance.
