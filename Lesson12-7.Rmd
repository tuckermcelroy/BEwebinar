...
- After differencing, we wish to estimate $\gamma (1)$ and compute the cdf $\zeta = {\mathbb P} [ \sqrt{n} (\widehat{\gamma} (1) - \gamma (1)) \leq x]$.
...
- The $95 \%$ confidence interval based on subsampling is [`r ndc.acf1 - interval[2]/sqrt(n)`,`r ndc.acf1 - interval[1]/sqrt(n)`].
